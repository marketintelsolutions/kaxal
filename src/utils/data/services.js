...
import agriBusiness from '../../assets/images/agriBusiness.png'
...
export const hawareeServices = [
    {
        img: shopping,
        head: 'Online Shopping',
        text: 'Beyond the traditional online shopping, we are poised to introduce virtual reality retail giving our users a deeper shopping satisfaction experience.'
    },
    {
        img: digital,
        head: 'Digital Services',
        text: 'We intend to make the hawaree.com platform a-one-stop shop where users can make seamlessly access digital services such as bills payments (utilities, entertainment); download music, buy airtime and data, create gift cards, etc.'
    },
    {
        img: logistics,
        head: 'Logistics Services',
        text: 'Provision of prompt and secured delivery services for our stakeholders.'
    },
    {
        img: others,
        head: 'Other Added Services',
        text: 'Using technology, we are promoting a savings culture where users/shoppers saves per purchases made on the platform.'
    },
]